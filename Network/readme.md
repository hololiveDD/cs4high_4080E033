...
追蹤 www.pchome.com.tw [210.59.230.39] 的路由:
  ...
  1     3 ms     1 ms    <1 ms  172.20.155.254
  2     5 ms     6 ms     5 ms  172.16.190.253
...
追蹤 www.ksu.edu.tw [120.114.100.65] 的路由:
  ...
  2    <1 ms     2 ms    <1 ms  120-114-50-230.ksu.edu.tw [120.114.50.230]
...
```
UDP報文包括4個欄位，每個欄位占用2個位元組（即16個位元）。
